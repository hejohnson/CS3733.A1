...
public class DeucesTableauController extends java.awt.event.MouseAdapter {
	...
	ColumnView thisTableauView;
	/**
	 * FoundationController constructor comment.
	 */
	public DeucesTableauController(Deuces game, ColumnView thisTableauView) {
		super();

		this.game = game;
		this.thisTableauView = thisTableauView;
	}
	/**
	...
	public void mouseReleased(MouseEvent me) {
		...
		Column thisTableau = (Column) thisTableauView.getModelElement();
		...
		Move m = new MoveToTableauMove (source, col, thisTableau);
	...
	public void mousePressed(MouseEvent me) {
		...
		ColumnView cards = thisTableauView.getColumnView (me);
		...
		c.setDragSource (thisTableauView);
